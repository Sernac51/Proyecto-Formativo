...
<body class="d-flex h-100 text-center text-white">
    <div class="d-flex h-100 w-100 p-3 mx-autpt-5o flex-column main-container">
        ...
        <div class="contauner-fliud">
            <main class="mx-3">
                <p class="fs-4 fw-lighter pb-5">AJ aluminio y decoración es una empresa que se preocupa por ofrecer productos de calidad aus clientes.</p>
                    <div class="row">
                        <div>
                            <a href="{{ route('usuarios.index')}}" class="btn btn-outline-warning fs-2 w-25" >Ingresar</a> 
                        </div>   
                    </div>  
            </main>
        </div>
